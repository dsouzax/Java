...
public class PaintJob {
    ...
    public static int getBucketCount(double width, double height, double areaPerBucket, int extraBuckets){
        double area, remainingArea, bucketsRequired;
        ...
        area = width * height;
        remainingArea = area - (extraBuckets * areaPerBucket);
        bucketsRequired = Math.ceil(remainingArea / areaPerBucket);

        return (int) bucketsRequired;
    }

    public static int getBucketCount(double width, double height, double areaPerBucket){
        double area, bucketsRequired;
        ...
        area = width * height;
        bucketsRequired = Math.ceil(area / areaPerBucket);
